            ...
            <div class="col-lg-6 mx-auto">
                <div class="card shadow">
                    <div class="card-header cat-head align-items-center d-flex justify-content-between">
                        <h5 class="card-title fw-bold">Create Warehouse</h5>
                        <h4 class="card-title mb-0 flex-grow-1">
                            <p class="text-center text-success"> {{ Session::get('message') }} </p>
                        </h4>
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md">
                                <a href="{{ route('Shop-warehouse.index') }}" class="btn create-btn-outline"> Warehouse
                                    List
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="live-preview">
                                    <div class="row gy-4">
                                        <form action="{{ route('warehouse.new') }}" method="post"
