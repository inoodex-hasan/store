                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="shop_id" required>
                            ...
                            <option value="{{ $shop->id }}" {{ $shop->id == $user_manage->shop_id ? 'selected' : '' }}>{{ $shop->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="user_id" name="user_id" required>
                            ...
                            <option value="{{ $user->id }}" data-role="{{ $user->role->id ?? '' }}" {{ $user->id == $user_manage->user_id ? 'selected' : '' }}>{{ $user->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="role_display" disabled>
                            ...
                            <option value="{{ $role->id }}" {{ $role->id == $user_manage->role_id ? 'selected' : '' }}>{{ $role->name }}</option>
                            @endforeach
                        </select>
                        <input type="hidden" name="role_id" id="role_id" value="{{ $user_manage->role_id }}">
                    </div>
                    <div class="col-12">
