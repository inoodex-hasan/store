            ...
            <form action="{{ route('role.store') }}" method="post">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" value="{{ old('name') }}" name="name" placeholder="Enter Role name" required>
                    </div>
                    <div class="col-md-8">
                        ...
                        <div class="row g-2 mt-2">
                            ...
                            <div class="col-6 col-md-4 col-lg-3" style="border:1px solid #ddd; padding:8px; border-radius:7px">
                                <div class="form-check form-switch" style="padding-left: 2.5em;">
                                    <input class="form-check-input" type="checkbox" role="switch" name="permissions[]" id="permission_{{ $item->id }}" value="{{ $item->id }}">
